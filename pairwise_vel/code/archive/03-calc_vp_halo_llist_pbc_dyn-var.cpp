...
//                    cout<<"i: "<<i<<"\t"<<"j: "<<j<<"\t"<<"binsep: "<<binsep<<"\t"<<"binM: "<<binM<<"\t"<<"pair_vel: "<<pair_vel<<endl;
                    double vpPrev = vp(binsep, binM);
#pragma omp atomic
                    Nvp(binsep, binM) += 1.;
#pragma omp atomic write
	            vp(binsep, binM) = vp(binsep, binM) * (Nvp(binsep, binM) - 1.) / Nvp(binsep, binM) + pair_vel / Nvp(binsep, binM);
                    double NRatio = Nvp(binsep, binM) / (Nvp(binsep, binM) - 1.);
#pragma omp atomic write
	            vp2(binsep, binM) = vp2(binsep, binM) * Nvp(binsep, binM) / (Nvp(binsep, binM) - 1.) * NRatio + pair_vel*pair_vel * NRatio + vpPrev * vpPrev * NRatio - vp(binsep, binM) * vp(binsep, binM) * NRatio;
                  }
                }
	      }
