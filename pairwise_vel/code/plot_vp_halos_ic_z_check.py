# Compare linear velocity predictions from low and high redshift IC output
# for Abacus halos
# v0.1.0, 2021-11-05 - Code started, copied from plot_vp_halos_plt_check.py
...
ic_types = ["ngc_nplt", "ngc_nplt_0.7"]
z = 0.7
N_bins = 80
...
for i in range(mass_bin_lims.size-1):
    ...
    plt.savefig("../output/plots/"
                "abacus_m200b_{:.2f}-{:.2f}_vp_ic_z_test"
