...
real_cat_path = ("/home/mj3chapm/scratch/abacus/"
                 ...
                 "AbacusCosmos_1100box_00_{}_halos/z0.700/"
                 "halo_lin_vel_smoothed.dat".format(halotype))
...
if load_dvs:
    ref_dv = np.loadtxt("/home/mj3chapm/scratch/abacus/"
                        ...
                        "AbacusCosmos_1100box_00_products/"
                        "AbacusCosmos_1100box_00_{}_halos/z0.700/"
                        "em_model_test/planck_00_{}_halos"
...
for i, gamma_val in enumerate(gamma_vals):
    output_root = ("/home/mj3chapm/scratch/abacus/"
                   ...
                   "AbacusCosmos_1100box_00_{}_halos/z0.700/"
                   "em_model_test/planck_00_{}_halos"
                   "_{}_{}_slv".format(halotype, halotype, run_name,
                                       gamma_val))
    if load_dvs:
        red_dv = np.loadtxt("/home/mj3chapm/scratch/abacus/"
                            "AbacusCosmos_1100box_products/"
                            "AbacusCosmos_1100box_00_products/"
                            "AbacusCosmos_1100box_00_{}_halos/"
                            "z0.700/em_model_test/planck_00_{}_halos"
...
plt.savefig("{}_cf_check_slv.jpg".format(output_root))
