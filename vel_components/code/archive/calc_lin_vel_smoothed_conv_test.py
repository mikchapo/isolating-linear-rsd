...
for i in range(subsample_array.shape[0]):
    subsample_array[i, 4:] = ic_array[i, 1:]

del ic_array

print("First quarter, first 10 parts:", subsample_array[:10])
print("Second quarter, first 10 parts:",
      subsample_array[int(subsample_array.shape[0] / 4): int(subsample_array.shape[0] / 4) + 10])
print("Third quarter, first 10 parts:",
      subsample_array[int(subsample_array.shape[0] / 2): int(subsample_array.shape[0] / 2) + 10])
print("Fourth quarter, first 10 parts:",
      subsample_array[int(subsample_array.shape[0] / 4 * 3): int(subsample_array.shape[0] / 4 * 3) + 10])
...
np.savetxt("test_cats/smooth_vel_array_conv.txt".format(rank),
           smooth_vel_array)
...
np.savetxt("test_cats/halo_lin_vel_smoothed_conv.dat",
