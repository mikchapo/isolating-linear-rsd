...
# v0.1.0, 2022-08-18 - Copied from create_part_cat.py
...
redshifts = [{"label": "z0.300", "z_cat": 0.3},
             {"label": "z0.700", "z_cat": 0.7},
             {"label": "z1.500", "z_cat": 1.5}]
boxid = "00-0"
z_ic = 49.
info_path = ("/home/mj3chapm/scratch/abacus/"
             "AbacusCosmos_1100box_planck_products/"
             "AbacusCosmos_1100box_planck_{}_products/"
             "AbacusCosmos_1100box_planck_{}_rockstar_halos/"
             "info".format(boxid, boxid))
ic_dir = ("/home/mj3chapm/scratch/abacus/AbacusCosmos_1100box_planck_products/"
          "AbacusCosmos_1100box_planck_{}_products/"
          "ic_ngc_nplt_z49.0".format(boxid))
...
np.savetxt("/home/mj3chapm/scratch/abacus/AbacusCosmos_1100box_planck_products/"
           "AbacusCosmos_1100box_planck_{}_products/"
           "AbacusCosmos_1100box_planck_{}_rockstar_halos/z0.700/"
           "ic_part_{}.dat".format(boxid, boxid, sample_size),
           particle_sample, header=header)


# Change Log
# v0.2.0, 2021-12-10 - Updated with final velocity scaling and for general use
