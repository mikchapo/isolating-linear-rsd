...
xc = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/abacus_share/AbacusCosmos_1100box_rockstar_halos_z0.700_smoothed_lin_vel/training_cosmology.dat")
...
HHmask = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/GP_MeanAxis3/HOD_mask_monopole.dat")

datatemp = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/training_clustering3/Results_Mean/CF_cosmo_0_HOD_0_test_0_mean.dat")
## datatemp: some RSD measurments have s=nan for the first bin, so for quadrupole, enforce its s to be the same as datatemp

pp = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/GP_MeanAxis3/GP_qu2/"+data+"_quad_9bins_pp_Nsize_"+str(Nsize1)+"_"+str(Nsize2)+"+N_hod_up"+str(N_hod_up)+".dat")
...
for CID in CC:
    ...
    for HID in HH3[Nsize1:Nsize2]:
        ...
        d = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/training_clustering3/Results_Mean/CF_cosmo_"+str(CID)+"_HOD_"+str(HID)+"_test_0_mean.dat")
