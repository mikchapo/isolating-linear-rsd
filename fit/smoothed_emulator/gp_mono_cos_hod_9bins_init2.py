...
pp = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/GP_MeanAxis3/GP_mo/"+data+"_mono_9bins_pp_Nsize_"+str(Nsize1)+"_"+str(Nsize2)+"+N_hod_up"+str(N_hod_up)+".dat")
