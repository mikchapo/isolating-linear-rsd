...
class GET_PriorND(object):
    def __init__(self):
        self.cosmo = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/abacus_share/AbacusCosmos_1100box_rockstar_halos_z0.700_smoothed_lin_vel/training_cosmology.dat")
