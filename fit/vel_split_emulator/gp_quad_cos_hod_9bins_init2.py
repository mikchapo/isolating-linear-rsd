...
datatemp = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/training_clustering/Results_Mean/CF_cosmo_0_HOD_0_test_0_mean.dat")
## datatemp: some RSD measurments have s=nan for the first bin, so for quadrupole, enforce its s to be the same as datatemp

pp = np.loadtxt("/home/mj3chapm/projects/rrg-wperciva/zhai/Emulator/Abacus/eBOSS/GP_MeanAxis/GP_qu2/"+data+"_quad_9bins_pp_Nsize_"+str(Nsize1)+"_"+str(Nsize2)+"+N_hod_up"+str(N_hod_up)+".dat")
